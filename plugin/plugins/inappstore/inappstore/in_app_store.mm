...
void InAppStore::_bind_methods() {
    ClassDB::bind_method("request_product_info", &InAppStore::request_product_info);
    ClassDB::bind_method("restore_purchases", &InAppStore::restore_purchases);
    ClassDB::bind_method("purchase", &InAppStore::purchase);

    ClassDB::bind_method("get_pending_event_count", &InAppStore::get_pending_event_count);
    ClassDB::bind_method("pop_pending_event", &InAppStore::pop_pending_event);
    ClassDB::bind_method("finish_transaction", &InAppStore::finish_transaction);
    ClassDB::bind_method("set_auto_finish_transaction", &InAppStore::set_auto_finish_transaction);
}
